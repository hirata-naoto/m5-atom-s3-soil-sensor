...
M5 Atom S3とDFROBOT SENS0604(RS485土壌センサー)を組み合わせた土壌水分・温度測定システムです。

## 概要

- **マイコン**: M5 Atom S3
- **センサー**: DFROBOT SENS0604 (RS485 Modbus RTU)
- **計測項目**: 土壌水分量、温度、EC値
...
├── wiring.md                 # 配線図と接続方法
├── docs/
│   └── modbus-registers.md   # SENS0604 Modbusレジスタ仕様
└── src/
...
- [DFROBOT SENS0604 仕様書](https://www.dfrobot.com/)
